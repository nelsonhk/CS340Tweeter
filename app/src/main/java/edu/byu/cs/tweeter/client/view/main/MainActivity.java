...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    @Override
    public void updateFollowingAndFollowersCounts() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedUser.compareTo(Cache.getInstance().getCurrUser()) == 0) {
            ...
            mainPresenter.getIsFollowing(selectedUser);
        }
    ...
    public void updateSelectedUserFollowingAndFollowers() {
        ...
        mainPresenter.getFollowerCount(selectedUser, executor);
        mainPresenter.getFollowingCount(selectedUser, executor);
    }
